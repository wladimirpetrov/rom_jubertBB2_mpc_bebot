...
bool ros_auv_v1_sub_l1_bebot_cpp__msg__optimization_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_auv_v1_sub_l1_bebot_cpp.msg._optimization_status.OptimizationStatus", full_classname_dest, 71) == 0);
  }
  ros_auv_v1_sub_l1_bebot_cpp__msg__OptimizationStatus * ros_message = _ros_message;
  {  // ready
...
{
  /* NOTE(esteve): Call constructor of OptimizationStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_auv_v1_sub_l1_bebot_cpp.msg._optimization_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OptimizationStatus");
