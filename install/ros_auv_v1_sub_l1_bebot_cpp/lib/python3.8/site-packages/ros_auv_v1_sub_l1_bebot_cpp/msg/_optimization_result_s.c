...
bool ros_auv_v1_sub_l1_bebot_cpp__msg__optimization_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_auv_v1_sub_l1_bebot_cpp.msg._optimization_result.OptimizationResult", full_classname_dest, 71) == 0);
  }
  ros_auv_v1_sub_l1_bebot_cpp__msg__OptimizationResult * ros_message = _ros_message;
  {  // solution_x
    PyObject * field = PyObject_GetAttrString(_pymsg, "solution_x");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->solution_x.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'solution_x'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // final_obj_value
    PyObject * field = PyObject_GetAttrString(_pymsg, "final_obj_value");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->final_obj_value = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // t0
...
{
  /* NOTE(esteve): Call constructor of OptimizationResult */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_auv_v1_sub_l1_bebot_cpp.msg._optimization_result");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OptimizationResult");
  ...
  {  // solution_x
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "solution_x");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->solution_x.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->solution_x.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->solution_x.size * sizeof(double));
      assert(data != NULL);
  ...
  {  // final_obj_value
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->final_obj_value);
    {
      int rc = PyObject_SetAttrString(_pymessage, "final_obj_value", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
